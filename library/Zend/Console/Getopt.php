 ...
 *
 * Examples:
 * - 'usuario|username|u=s'  this means '--usuario' or '--username' or '-u'
 ...
 *        Set value of parameter to the array of values.  Allow usuario to specify
 ...
 *
 * @todo  Enable usuario to specify header and footer content in the help message.
 *
...
class Zend_Console_Getopt
{
     ...
     * ruleMode is either 'zend' or 'gnu' or a usuario-defined mode.
    ...
    /**
     * Stores options given by the usuario in the current invocation
