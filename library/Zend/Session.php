...
class Zend_Session extends Zend_Session_Abstract
{
     ...
     * the usuario has set an option explicity with setOptions()
     *
     * @var array
     */
    ...
    {
        // set default options on first run only (before applying usuario settings)
        ...
        // set the options the usuario has requested to set
     ...
     *
     * @param bool|array $options  OPTIONAL Either usuario supplied options, or flag indicating if start initiated automatically
     * @throws Zend_Session_Exception
     * @return void
     */
    ...
    /**
     * setId() - set an id to a usuario specified id
     *
     * @throws Zend_Session_Exception
     * @param string $id
     * @return void
