 ...
 *
 * To transfer usuario entries to and from the servers, including
...
class Zend_Gdata_Photos_UserEntry extends Zend_Gdata_Entry
{
    ...
    public function __construct($element = null)
    {
        ...
        $category = new Zend_Gdata_App_Extension_Category(
            'http://schemas.google.com/photos/2007#usuario',
    ...
    protected function takeChildFromDOM($child)
    {
        ...
        switch ($absoluteNodeName) {
            ...
            case $this->lookupNamespace('gphoto') . ':' . 'thumbnail';
                ...
                break;
            case $this->lookupNamespace('gphoto') . ':' . 'usuario';
    ...
    /**
     * Get the value for this element's gphoto:usuario attribute.
     *
     * @see setGphotoUser
     * @return string The requested attribute.
     */
    ...
    /**
     * Set the value for this element's gphoto:usuario attribute.
     *
     * @param string $value The desired value for this attribute.
