...
/**
 * Assists in constructing queries for usuario entries.
...
class Zend_Gdata_Photos_UserQuery extends Zend_Gdata_Query
{
    ...
    /**
     * A string which, if not null, indicates which usuario should
     * be retrieved by this query. If null, the default usuario will be used
     * instead.
     *
     * @var string
     */
    ...
    /**
     * Set the usuario to query for. When set, this usuario's feed will be
     * returned. If not set or null, the default usuario's feed will be returned
     * instead.
     *
     * @param string $value The usuario to retrieve, or null for the default
     *          usuario.
     */
    ...
    /**
     * Get the usuario which is to be returned.
     *
     * @see setUser
