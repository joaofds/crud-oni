...
class Zend_Gdata_Gapps extends Zend_Gdata
{
    ...
    /**
     * Path to usuario feeds on the Google Apps server.
     */
    const APPS_USER_PATH = '/usuario/2.0';
    ...
    /**
     * Create a new usuario from a UserEntry.
     *
     * @param Zend_Gdata_Gapps_UserEntry $user The usuario entry to insert.
     * @param string $uri (optional) The URI where the usuario should be
     *          uploaded to. If null, the default usuario creation URI for
     *          this domain will be used.
     * @return Zend_Gdata_Gapps_UserEntry The inserted usuario entry as
    ...
    /**
     * Create a new usuario entry and send it to the Google Apps servers.
     *
     * @param string $username The username for the new usuario.
     * @param string $givenName The given name for the new usuario.
     * @param string $familyName The family name for the new usuario.
     * @param string $password The password for the new usuario as a plaintext string
     *                 (if $passwordHashFunction is null) or a SHA-1 hashed
     *                 value (if $passwordHashFunction = 'SHA-1').
     * @param string $quotaLimitInMB (optional) The quota limit for the new usuario in MB.
     * @return Zend_Gdata_Gapps_UserEntry (optional) The new usuario entry as returned by
     *                 server.
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Zend_Gdata_Gapps_ServiceException
    ...
    /**
     * Retrieve a usuario based on their username.
     *
    ...
    public function retrieveUser ($username) {
        ...
        try {
            ...
            // Set the usuario to null if not found
     ...
     * @param Zend_Gdata_Gapps_UserEntry $userEntry The usuario entry which
     *          will be overwritten.
    ...
    /**
     * Mark a given usuario as suspended.
     *
     * @param string $username The username associated with the usuario who
     *          should be suspended.
    ...
    /**
     * Mark a given usuario as not suspended.
     *
     * @param string $username The username associated with the usuario who
     *          should be restored.
     * @return Zend_Gdata_Gapps_UserEntry The UserEntry for the modified
    ...
    /**
     * Create a nickname for a given usuario.
     *
     ...
     *          for the given usuario, or null if
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Zend_Gdata_Gapps_ServiceException
     */
    ...
    /**
     * Retrieve all of the groups that a usuario is a member of
     *
