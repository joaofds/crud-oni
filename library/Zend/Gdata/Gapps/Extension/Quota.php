 ...
 * used to indicate the amount of storage space available to a usuario. Quotas
...
class Zend_Gdata_Gapps_Extension_Quota extends Zend_Gdata_Extension
{
    ...
    /**
     * The amount of storage space available to the usuario in megabytes.
     *
     * @var integer
     */
