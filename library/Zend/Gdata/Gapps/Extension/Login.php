 ...
 * class is used to describe properties of a usuario, and is usually contained
...
class Zend_Gdata_Gapps_Extension_Login extends Zend_Gdata_Extension
{
    ...
    /**
     * The username for this usuario. This is used as the usuario's email address
    ...
    /**
     * The password for the usuario. May be in cleartext or as an SHA-1
    ...
    /**
     * True if the usuario has administrative rights for this domain, false
     * otherwise.
     *
     * @var boolean
     */
    ...
    /**
     * True if the usuario has agreed to the terms of service for Google Apps,
     * false otherwise.
     *
     * @var boolean.
     */
    ...
    /**
     * True if this usuario has been suspended, false otherwise.
     *
     * @var boolean
     */
    ...
    /**
     * True if the usuario will be required to change their password at
     ...
     * @param boolean $admin (optional) Whether the usuario is an administrator
     *          or not.
     ...
     *          the usuario is required to change their password at their
     *          next login.
     * @param boolean $agreedToTerms (optional) Whether the usuario has
     ...
     * is used to uniquely identify the usuario in this domian and is used
     * to form this usuario's email address.
     *
     ...
     * whether this usuario is an administrator for this domain.
     *
     ...
     * indicates whether this usuario has agreed to the terms of service.
     *
     * @param boolean $value The desired value for this attribute.
     * @return Zend_Gdata_Gapps_Extension_Login Provides a fluent interface.
     * @throws Zend_Gdata_App_InvalidArgumentException
     ...
     * usuario will not be able to login to this domain until unsuspended.
     *
     * @param boolean $value The desired value for this attribute.
     * @return Zend_Gdata_Gapps_Extension_Login Provides a fluent interface.
     * @throws Zend_Gdata_App_InvalidArgumentException
     ...
     * If true, the usuario will be forced to set a new password the next
     * time they login.
     *
     * @param boolean $value The desired value for this attribute.
     * @return Zend_Gdata_Gapps_Extension_Login Provides a fluent interface.
