 ...
 * to represent a usuario's full name. This class is usually contained within
...
class Zend_Gdata_Gapps_Extension_Name extends Zend_Gdata_Extension
{
    ...
    /**
     * The associated usuario's family name.
     *
     * @var string
     */
    ...
    /**
     * The associated usuario's given name.
     *
     * @var string
     */
     ...
     * represents a usuario's family name.
     *
     ...
     * represents a usuario's given name.
     *
     * @param string $value The desired value for this attribute.
     * @return Zend_Gdata_Gapps_Extension_Name Provides a fluent interface.
     */
