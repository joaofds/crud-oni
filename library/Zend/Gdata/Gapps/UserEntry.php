 ...
 *
 * Each usuario entry describes a single usuario within a Google Apps hosted
 * domain.
 *
 * To transfer usuario entries to and from the Google Apps servers, including
...
class Zend_Gdata_Gapps_UserEntry extends Zend_Gdata_Entry
{
    ...
    /**
     * <apps:login> element containing information about this usuario's
    ...
    /**
     * <apps:name> element containing the usuario's actual name.
     *
     ...
     * is used to store the username address of the current usuario.
     *
     ...
     * is used to store the full name of the current usuario.
     *
     ...
     * usuario. Quotas may not be modifiable depending on the domain used.
     *
