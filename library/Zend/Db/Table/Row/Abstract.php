...
abstract class Zend_Db_Table_Row_Abstract implements ArrayAccess, IteratorAggregate
{
     ...
     *
     * @param  array $config OPTIONAL Array of usuario-specified config options.
     * @return void
    ...
    /**
     * Transform a column name from the usuario-specified form
     ...
     *
     * @param  string $columnName The usuario-specified column name.
