...
abstract class Zend_Db_Table_Abstract
{
     ...
     * - db              = usuario-supplied instance of database connector,
     ...
     *
     * @param  mixed $config Array of usuario-specified config options, or just the Db Adapter.
     * @return void
     */
     ...
     * - If this is boolean false, then the key is usuario-defined.
    ...
    public function insert(array $data)
    {
         ...
         * specified in the usuario-supplied data, then omit it from the tuple.
         *
         ...
         * or IDENTITY column, unless the usuario has specified a value,
    ...
    /**
     * Generate WHERE clause from usuario-supplied string or array
     *
    ...
    /**
     * Generate ORDER clause from usuario-supplied string or array
     *
     * @param  string|array $order  OPTIONAL An SQL ORDER clause.
     * @return Zend_Db_Table_Select
     */
