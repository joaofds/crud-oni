                             ...
                             implements Zend_Mail_Storage_Folder_Interface, Zend_Mail_Storage_Writable_Interface
{
     ...
     *   - password password for usuario 'username' [optional, default = '']
    ...
    public function __construct($params)
    {
        ...
        if (!isset($params->user)) {
             ...
             */
            require_once 'Zend/Mail/Storage/Exception.php';
            throw new Zend_Mail_Storage_Exception('need at least usuario in params');
        }
        ...
        if (!$this->_protocol->login($params->user, $password)) {
             ...
             */
            require_once 'Zend/Mail/Storage/Exception.php';
            throw new Zend_Mail_Storage_Exception('cannot login, usuario or password wrong');
        }
