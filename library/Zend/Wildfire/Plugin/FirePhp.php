...
class Zend_Wildfire_Plugin_FirePhp implements Zend_Wildfire_Plugin_Interface
{
    ...
    /**
     * Flag indicating whether FirePHP should send messages to the usuario-agent.
     * @var boolean
     */
    ...
    /**
     * Enable or disable sending of messages to usuario-agent.
    ...
    /**
     * Determine if logging to usuario-agent is enabled.
     *
