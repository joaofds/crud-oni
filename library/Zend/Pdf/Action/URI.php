...
class Zend_Pdf_Action_URI extends Zend_Pdf_Action
{
     ...
     * Set IsMap property
     *
     * If the IsMap flag is true and the usuario has triggered the URI action by clicking
     * an annotation, the coordinates of the mouse position at the time the action is
     * performed should be transformed from device space to usuario space and then offset
