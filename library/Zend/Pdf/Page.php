...
class Zend_Pdf_Page extends Zend_Pdf_Canvas_Abstract
{
  ...
  /* Line Dash Types */
     ...
     * ---------------------------------------------------------
     *
     * 4. Create new page with a specified pagesize (in default usuario space units).
     *    If $factory is null then it will be created and page must be attached to the document to be
     *    included into output.
     * ---------------------------------------------------------
    ...
    public function __construct($param1, $param2 = null, $param3 = null)
    {
        if (($param1 instanceof Zend_Pdf_Element_Reference ||
            ...
            if(count($pageDim) == 2  ||  count($pageDim) == 3) {
                ...
                /**
                 * @todo support of usuario defined pagesize notations, like:
            ...
            /**
             * @todo support of pagesize recalculation to "default usuario space units"
             */
