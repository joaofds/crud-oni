...
class Zend_Controller_Router_Route_Hostname extends Zend_Controller_Router_Route_Abstract
{
    ...
    /**
     * Holds usuario submitted default values for route's variables. Name and value pairs.
     *
     * @var array
     */
    ...
    /**
     * Holds usuario submitted regular expression patterns for route's variables' values.
    ...
    /**
     * Matches a usuario submitted path with parts defined by a map. Assigns and
    ...
    /**
     * Assembles usuario submitted parameters forming a hostname defined by this route
     *
     ...
     * @return string Route path with usuario submitted parameters
     */
