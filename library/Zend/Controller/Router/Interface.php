...
interface Zend_Controller_Router_Interface
{
     ...
     *
     * May be passed usuario params to override ones from URI, Request or even defaults.
     ...
     *
     * @param  array $userParams Options passed by a usuario used to override parameters
