...
class Zend_Amf_Parse_Amf0_Serializer extends Zend_Amf_Parse_Serializer
{
     ...
     * auto negotiates the type or relies on the usuario defined markerType to
    ...
    protected function getClassName($object)
    {
        ...
        switch (true) {
            ...
            case Zend_Amf_Parse_TypeLoader::getMappedClassName(get_class($object)):
                ...
                break;
                // Check to see if the usuario has defined an explicit Action Script type.
            case isset($object->_explicitType):
                $className = $object->_explicitType;
                break;
                // Check if usuario has defined a method for accessing the Action Script type
