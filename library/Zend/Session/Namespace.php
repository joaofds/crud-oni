...
class Zend_Session_Namespace extends Zend_Session_Abstract implements IteratorAggregate
{
    ...
    /**
     * apply() - enables applying usuario-selected function, such as array_merge() to the namespace
    ...
    /**
     * applySet() - enables applying usuario-selected function, and sets entire namespace to the result
