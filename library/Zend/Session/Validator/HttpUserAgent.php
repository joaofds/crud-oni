...
class Zend_Session_Validator_HttpUserAgent extends Zend_Session_Validator_Abstract
{
    ...
    /**
     * Setup() - this method will get the current usuario agent and store it in the session
     * as 'valid data'
     *
     * @return void
     */
    ...
    /**
     * Validate() - this method will determine if the current usuario agent matches the
     * usuario agent we stored when we initialized this variable.
     *
     * @return bool
     */
