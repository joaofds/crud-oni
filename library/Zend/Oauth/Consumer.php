...
class Zend_Oauth_Consumer extends Zend_Oauth
{
    ...
    /**
     * After a Request Token is retrieved, the usuario may be redirected to the
     ...
     * Once the usuario has authorized the application for access, they are
     ...
     * Request Token.
     *
     * @param  array $queryData GET data returned in usuario's redirect from Provider
