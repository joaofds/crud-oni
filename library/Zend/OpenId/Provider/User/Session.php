...
/**
 * Class to get/store information about logged in usuario in Web Browser using
 * PHP session
 *
 * @category   Zend
 * @package    Zend_OpenId
...
class Zend_OpenId_Provider_User_Session extends Zend_OpenId_Provider_User
{
    ...
    /**
     * Stores information about logged in usuario in session data
     *
    ...
    /**
     * Returns identity URL of logged in usuario or false
     *
     * @return mixed
     */
