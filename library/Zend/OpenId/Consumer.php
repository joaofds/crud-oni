...
class Zend_OpenId_Consumer
{
    ...
    /**
     * Performs check (with possible usuario interaction) of OpenID identity.
     *
    ...
    /**
     * Performs immediate check (without usuario interaction) of OpenID identity.
     *
     * This is the first step of OpenID authentication process.
     * On success the function does not return (it does HTTP redirection to
     * server and exits). On failure it returns false.
     ...
     * @param string &$identity this argument is set to end-usuario's claimed
