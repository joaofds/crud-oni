...
class Zend_OpenId_Provider
{
    ...
    /**
     * Reference to an implementation of usuario object
     *
    ...
    /**
     * URL to peform interactive usuario login
     *
    ...
    /**
     * URL to peform interactive validation of consumer by usuario
     *
     ...
     *  end-usuario (by default it is the same URL with additional GET variable
     *  openid.action=login)
     * @param string $trustUrl is an URL that shows a question if end-usuario
     ...
     *  with User-Agent and store information about logged-in usuario (it is a
    ...
    /**
     * Registers a new usuario with given $id and $password
     * Returns true in case of success and false if usuario with given $id already
     * exists
     *
     * @param string $id usuario identity URL
     * @param string $password encoded usuario password
     * @return bool
     */
    ...
    /**
     * Returns true if usuario with given $id exists and false otherwise
     *
     * @param string $id usuario identity URL
     * @return bool
     */
    ...
    /**
     * Performs login of usuario with given $id and $password
     * Returns true in case of success and false otherwise
     *
     * @param string $id usuario identity URL
     * @param string $password usuario password
     * @return bool
     */
    ...
    /**
     * Performs logout. Clears information about logged in usuario.
     *
     * @return void
     */
    ...
    /**
     * Returns identity URL of current logged in usuario or false
     *
     * @return mixed
     */
     ...
     * in usuario. Returns true on success and false on error.
     *
     ...
     * in usuario. Next time this consumer will try to authenticate the usuario,
     * Provider will ask usuario's confirmation.
    ...
    /**
     * Returns list of known consumers for current logged in usuario or false
     ...
     * @param float $version OpenID version
     * @param array $params GET or POST request variables
     * @param bool $immediate enables or disables interaction with usuario
     * @param mixed $extensions extension object or array of extensions objects
        ...
        Zend_Controller_Response_Abstract $response = null)
    {
        ...
        /* Check if usuario already logged in into the server */
        if (!isset($params['openid_identity']) ||
        ...
        /* Check if usuario trusts to the consumer */
        $trusted = null;
