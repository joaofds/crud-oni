...
class Zend_Auth_Adapter_Ldap implements Zend_Auth_Adapter_Interface
{
    ...
    public function authenticate()
    {
        ...
        foreach ($this->_options as $name => $options) {
            ...
            try {
                ...
                /*
                 * Fixes problem when authenticated usuario is not allowed to retrieve
                 * group-membership information or own account.
                 * This requires that the usuario specified with "username" and optionally
                ...
                if ($groupResult === true) {
                    ...
                    if ($requireRebind === true) {
                        // rebinding with authenticated usuario
    ...
    /**
     * Checks the group membership of the bound usuario
     *
     * @param  Zend_Ldap $ldap
