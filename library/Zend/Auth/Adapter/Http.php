...
class Zend_Auth_Adapter_Http implements Zend_Auth_Adapter_Interface
{
    ...
    /**
     * Object that looks up usuario credentials for the Basic scheme
     *
    ...
    /**
     * Object that looks up usuario credentials for the Digest scheme
     *
     * @var Zend_Auth_Adapter_Http_Resolver_Interface
     */
    ...
    protected function _digestAuth($header)
    {
        ...
        // Look up the usuario's password hash. If not found, deny access.
        ...
        // If MD5-sess is used, a1 value is made of the usuario's password
    ...
    protected function _calcNonce()
    {
        ...
        // nonce will change on its own, and effectively log the usuario out. This
        // would be surprising if the usuario just logged in.
