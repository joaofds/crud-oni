    ...
    implements Zend_Http_UserAgent_Device
{
    ...
    protected function _getDefaultFeatures()
    {
        ...
        // gets info from usuario agent chain
    ...
    /**
     * Match a usuario agent string against a list of signatures
     *
     * @param  string $userAgent
        ...
        foreach ($signatures as $signature) {
            if (!empty($signature)) {
                if (strpos($userAgent, $signature) !== false) {
                    // Browser signature was found in usuario agent string
                    return true;
                }
            }
        }
