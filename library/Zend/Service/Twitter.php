...
class Zend_Service_Twitter
{
    ...
    /**
     * Blocks the usuario specified in the ID parameter as the authenticating usuario.
     * Destroys a friendship to the blocked usuario if it exists.
     *
     * @param  integer|string $id       The ID or screen name of a usuario to block.
     * @throws Exception\DomainException if unable to decode JSON payload
     * @return Zend_Service_Twitter_Response
     */
    ...
    /**
     * Un-blocks the usuario specified in the ID parameter for the authenticating usuario
     *
     * @param  integer|string $id       The ID or screen_name of the usuario to un-block.
     * @throws Exception\DomainException if unable to decode JSON payload
     * @return Zend_Service_Twitter_Response
     */
    ...
    /**
     * Returns an array of usuario ids that the authenticating usuario is blocking
     *
    ...
    /**
     * Returns an array of usuario objects that the authenticating usuario is blocking
     *
     * @param  integer $cursor  Optional. Specifies the cursor position at which to begin listing ids; defaults to first "page" of results.
     * @throws Exception\DomainException if unable to decode JSON payload
     * @return Zend_Service_Twitter_Response
    ...
    /**
     * Retrieve direct messages for the current usuario
     *
    ...
    /**
     * Send a direct message to a usuario
     *
     * @param  int|string $user User to whom to send message
     * @param  string $text Message to send to usuario
    ...
    /**
     * Retrieve list of direct messages sent by current usuario
     *
     * $options may include one or more of the following keys
     * - count: return page X of results
     ...
     * - user_id: Id of a usuario for whom to fetch favorites
     * - screen_name: Screen name of a usuario for whom to fetch favorites
     ...
     * - since_id: return results only after the specified tweet id
     * - max_id: return results with an ID less than (older than) or equal to the specified ID
     * - trim_user: when set to true, "t", or 1, usuario object in tweets will include only author's ID.
    ...
    /**
     * Update usuario's current status
     *
    ...
    /**
     * Show extended information on a usuario
     *
    ...
    /**
     * Create a parameter representing the usuario
     *
