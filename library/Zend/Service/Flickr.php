...
class Zend_Service_Flickr
{
    ...
    /**
     * Finds photos by a usuario's username or email.
     *
     ...
     *
     * (You can only find a usuario's photo with their NSID.)
     *
    ...
    public function getIdByUsername($username)
    {
        ...
        return (string) $xpath->query('//usuario')->item(0)->getAttribute('id');
    }
    ...
    */
     ...
     * @return array Merged array of usuario and default/required options
     */
    ...
    /**
     * Throws an exception if and only if any usuario options are invalid
     *
     * @param  array $options      User options
