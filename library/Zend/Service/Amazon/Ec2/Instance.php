...
class Zend_Service_Amazon_Ec2_Instance extends Zend_Service_Amazon_Ec2_Abstract
{
     ...
     *                                                userData string       The usuario data available to the launched instances. This should not be Base64 encoded.
     ...
     * will succeed if the instances are valid and belong to the usuario. Requests to reboot terminated instances are ignored.
     *
     ...
     * verify whether a usuario's instance is eligible.
     *
