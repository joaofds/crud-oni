...
class Zend_Service_Amazon_Ec2_CloudWatch extends Zend_Service_Amazon_Ec2_Abstract
{
     ...
     *  show the usuario the size of the dataset collected. This will allow the usuario to properly
     *  weight the data.
     *
     ...
     *  instance. This allows a usuario to pinpoint an exact instance from which to monitor data.
     *
     * InstanceType: This dimension filters the data you request for all instances running
     *  with this specified instance type. This allows a usuario to catagorize his data by the
     *  type of instance running. For example, a usuario might compare data from an m1.small instance
