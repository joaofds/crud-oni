...
class Zend_Service_Amazon_Ec2_Image extends Zend_Service_Amazon_Ec2_Abstract
{
     ...
     * the image is owned by the usuario registering the image.
     *
    ...
    /**
     * Returns information about AMIs, AKIs, and ARIs available to the usuario.
     * Information returned includes image type, product codes, architecture,
     * and kernel and RAM disk IDs. Images available to the usuario include public
     * images available for any usuario to launch, private images owned by the usuario
     * making the request, and private images owned by other users for which the
     * usuario has explicit launch permissions.
     *
     ...
     *      explicit: The owner of the AMI granted launch permissions to a specific usuario.
     *      implicit: A usuario has implicit launch permissions for all AMIs he or she owns.
     *
     ...
     * all AMIs for which the usuario has launch permissions.
     *
     ...
     *                          charge users for using AMIs. The usuario must be signed up for the
