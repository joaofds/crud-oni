...
class Zend_Service_Amazon_Ec2_Securitygroups extends Zend_Service_Amazon_Ec2_Abstract
{
     ...
     * (by IP range or an Amazon EC2 usuario-group pair), the source and destination port ranges
     ...
     * Adds permissions to a security group
     *
     * When authorizing a usuario/group pair permission, GroupName, SourceSecurityGroupName and
     ...
     *
     * @param string $name                  Name of the group to modify.
     * @param string $groupName             Name of security group to authorize access to when operating on a usuario/group pair.
     * @param string $ownerId               Owner of security group to authorize access to when operating on a usuario/group pair.
     * @return boolean
     */
     ...
     * possible. However, depending on the number of instances, a small delay might occur.
     *
     * When revoking a usuario/group pair permission, GroupName, SourceSecurityGroupName and
     * SourceSecurityGroupOwnerId must be specified.
     *
     * @param string $name                  Name of the group to modify.
     * @param string $groupName             Name of security group to revoke access to when operating on a usuario/group pair.
     * @param string $ownerId               Owner of security group to revoke access to when operating on a usuario/group pair.
     * @return boolean
     */
