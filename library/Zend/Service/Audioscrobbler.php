...
class Zend_Service_Audioscrobbler
{
    ...
    protected function _getInfo($service, $params = null)
    {
        ...
        } elseif (preg_match('/No usuario exists with this name/', $responseBody)) {
            /**
             * @see Zend_Http_Client_Exception
             */
            require_once 'Zend/Http/Client/Exception.php';
            throw new Zend_Http_Client_Exception('No usuario exists with this name');
    ...
    */
    ...
    {
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/profile.xml";
        return $this->_getInfo($service);
    }

    /**
     * Utility function get this usuario's 50 most played artists
     *
     * @return array containing info
    */
    public function userGetTopArtists()
    {
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/topartists.xml";
        return $this->_getInfo($service);
    }

    /**
     * Utility function to get this usuario's 50 most played albums
     *
     * @return SimpleXMLElement object containing result set
    */
    public function userGetTopAlbums()
    {
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/topalbums.xml";
        return $this->_getInfo($service);
    }

    /**
     * Utility function to get this usuario's 50 most played tracks
     * @return SimpleXML object containing resut set
    */
    public function userGetTopTracks()
    {
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/toptracks.xml";
        return $this->_getInfo($service);
    }

    /**
     * Utility function to get this usuario's 50 most used tags
     *
     * @return SimpleXMLElement object containing result set
     */
    public function userGetTopTags()
    {
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/tags.xml";
        return $this->_getInfo($service);
    }

    /**
     * Utility function that returns the usuario's top tags used most used on a specific artist
     *
     * @return SimpleXMLElement object containing result set
     */
    public function userGetTopTagsForArtist()
    {
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/artisttags.xml";
        $params = "artist={$this->get('artist')}";
        return $this->_getInfo($service, $params);
    }

    /**
     * Utility function that returns this usuario's top tags for an album
     *
     * @return SimpleXMLElement object containing result set
     */
    public function userGetTopTagsForAlbum()
    {
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/albumtags.xml";
        $params = "artist={$this->get('artist')}&album={$this->get('album')}";
        return $this->_getInfo($service, $params);
    }

    /**
     * Utility function that returns this usuario's top tags for a track
     *
     * @return SimpleXMLElement object containing result set
     */
    public function userGetTopTagsForTrack()
    {
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/tracktags.xml";
        $params = "artist={$this->get('artist')}&track={$this->get('track')}";
        return $this->_getInfo($service, $params);
    }

    /**
     * Utility function that retrieves this usuario's list of friends
     * @return SimpleXMLElement object containing result set
     */
    public function userGetFriends()
    {
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/friends.xml";
        return $this->_getInfo($service);
    }

    /**
     * Utility function that returns a list of people with similar listening preferences to this usuario
     *
     * @return SimpleXMLElement object containing result set
     */
    public function userGetNeighbours()
    {
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/neighbours.xml";
        return $this->_getInfo($service);
    }

    /**
     * Utility function that returns a list of the 10 most recent tracks played by this usuario
     *
     * @return SimpleXMLElement object containing result set
     */
    public function userGetRecentTracks()
    {
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/recenttracks.xml";
        return $this->_getInfo($service);
    }

    /**
     * Utility function that returns a list of the 10 tracks most recently banned by this usuario
     *
     * @return SimpleXMLElement object containing result set
     */
    public function userGetRecentBannedTracks()
    {
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/recentbannedtracks.xml";
        return $this->_getInfo($service);
    }

    /**
     * Utility function that returns a list of the 10 tracks most recently loved by this usuario
     *
     * @return SimpleXMLElement object containing result set
     */
    public function userGetRecentLovedTracks()
    {
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/recentlovedtracks.xml";
        return $this->_getInfo($service);
    }

    /**
     * Utility function that returns a list of dates of available weekly charts for a this usuario
     *
    ...
    {
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/weeklychartlist.xml";
        return $this->_getInfo($service);
    }


    /**
     * Utility function that returns weekly album chart data for this usuario
     *
    ...
    public function userGetWeeklyAlbumChart($from = NULL, $to = NULL)
    {
        ...
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/weeklyalbumchart.xml";
        return $this->_getInfo($service, $params);
    }

    /**
     * Utility function that returns weekly artist chart data for this usuario
     *
     * @param integer $from optional UNIX timestamp for start of date range
     * @param integer $to optional UNIX timestamp for end of date range
     * @return SimpleXMLElement object containing result set
    ...
    public function userGetWeeklyArtistChart($from = NULL, $to = NULL)
    {
        ...
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/weeklyartistchart.xml";
        return $this->_getInfo($service, $params);
    }

    /**
     * Utility function that returns weekly track chart data for this usuario
     *
     * @param integer $from optional UNIX timestamp for start of date range
     * @param integer $to optional UNIX timestamp for end of date range
     * @return SimpleXMLElement object containing result set
    ...
    public function userGetWeeklyTrackChart($from = NULL, $to = NULL)
    {
        ...
        $service = "/{$this->get('version')}/usuario/{$this->get('usuario')}/weeklytrackchart.xml";
        return $this->_getInfo($service, $params);
    }
