...
class Zend_Service_Ebay_Finding_Error_Data extends Zend_Service_Ebay_Finding_Abstract
{
     ...
     * you retry the request. If the problem is due to incorrect usuario data,
     * alert the end-usuario to the problem and provide the means for them to
     ...
     * warning, you might need to contact the end usuario, or eBay, to effect a
